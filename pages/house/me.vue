        ...
        <view class="card" :class="{ 'global-flex': !id }">
          ...
          <view v-if="!id" class="account-info">
            ...
            <view class="button-login">
              <uv-button
                @click="id = 1"
                text="请登录"
                color="linear-gradient(to right, #1F57D8, #6390F5)"
                shape="circle"
              ></uv-button>
            </view>
          </view>
          <view class="me-info" v-else>
            <view class="info-top flex-center">
              <my-img
                src="/static/house/me-avatar.png"
                width="110rpx"
                height="110rpx"
              ></my-img>
              <view class="name-con">
            ...
            <view class="company">
              <text class="company-text"> 缴存单位: </text>
              中国邮政速递物流股份有限公司
            </view>
        ...
        <view class="more" @click="goHome">
          <view class="flex-center field-box">
            <view class="field-img">
              <my-img
                class="img-right"
                src="/static/house/house-more.png"
                width="52rpx"
                height="60rpx"
              ></my-img>
            </view>
